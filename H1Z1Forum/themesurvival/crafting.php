...
<div>
    ...
    <div id="main">
        ...
        <div class="container">
            ...
            <?php
            $stmt = $user_home->runQuery("SELECT starter, title, message, id FROM topics3");
            $stmt->execute([
            ]);
            $rows = $stmt->fetchAll();
            echo '<pre>';
            ...
            <STYLE>
                ...
                -->
            </STYLE> <a class="formtitellink" href="forum3.php?rowid=<?= $row['id'] ?>">  <?php echo '<h3>' .  $row['title'] . '</h3></a><hr>'  ?>
                <?php endforeach; ?>
                <table>
