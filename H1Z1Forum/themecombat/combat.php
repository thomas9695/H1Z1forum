...
<head>
    ...
    <link rel="stylesheet" href="../styles/css/bbb.css" type="text/css" />
</head>
<body>
...
<div>
    ...
    <div id="main">
        ...
        <div class="container">
            ...
            <form action="starttopic2.php">
                <input type="submit" value="start new post" href="starttopic2.php">
                <button formaction="../home.php">Back</button>
            </form> <hr>


            <?php
            $stmt = $user_home->runQuery("SELECT starter, title, message, id FROM topics2");
            $stmt->execute([
            ]);
            $rows = $stmt->fetchAll();
            echo '<pre>';
            ...
            <STYLE>
                ...
                -->
            </STYLE> <a class="formtitellink" href="forum2.php?rowid=<?= $row['id'] ?>">  <?php echo '<h3>' .  $row['title'] . '</h3></a><hr>'  ?>
                <?php endforeach; ?>
